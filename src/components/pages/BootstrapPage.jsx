import {
  bootstrapleftsidebaritems1,
  bootstrapleftsidebaritems2,
  bootstrapleftsidebaritems3,
  bootstrapreferences,
} from "../../constants";
  ...
  return (
    <main className="flex bg-[#E6E9EA] dark:bg-[#15212A] ">
      <span className="w-[20%] bg-[#E6E9EA] h-[3050px] text-black flex flex-col gap-y-2 pt-6 items-start overflow-auto scrollbar scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 dark:bg-[#15212A] dark:text-white">
        <h1 className="text-[21px] ml-4 mb-3">BOOTSTRAP TUTORIAL</h1>
        <div>
          {bootstrapleftsidebaritems1.map((item, i) => (
            <h1
              key={i}
        ...
        <h1 className="text-[21px] ml-4 mb-3">BOOTSTRAP Advanced</h1>
        <div>
          {bootstrapleftsidebaritems2.map((item, i) => (
            <h1 key={i} className="ml-4 cursor-pointer">
              {item}
            </h1>
          ))}
        </div>
        <h1 className="text-[21px] ml-4 mb-3">BOOTSTRAP Responsive</h1>
        <div>
          {bootstrapleftsidebaritems3.map((item, i) => (
            <h1 key={i} className="ml-4 cursor-pointer">
              {item}
            </h1>
          ))}
      ...
      <main className="bg-white w-full h-auto text-black dark:bg-[#1D2B34] dark:text-white pl-8  pr-8">
        ...
        <div className="flex flex-col justify-start items-start gap-y-4">
          ...
          <p>This BOOTSTRAP tutorial contains hundreds of Python examples.</p>
          <p>
        ...
        <div className="mt-6 mb-7">
          ...
          <p>
            ...
            Bootstrap, and click on a button to view the result.
          </p>
        ...
        <hr className="border mt-4" />
        <div className="mt-6 mb-7">
          <h1 className="text-[40px] mb-4">BOOTSTRAP Templates</h1>
          <p className="mb-2">
            We have created some responsive W3.BOOTSTRAP templates for you to
            use.
          </p>
          <p className="mb-2">
        ...
        <div className="mt-6 mb-7">
          <h1 className="text-[40px]">BOOTSTRAP Exercises</h1>
          <p>
            This BOOTSTRAP tutorial also contains nearly 100 HTML exercises.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-y-3">
          <h1 className="text-[40px]">Bootstrap Quiz</h1>
        ...
        <div className="flex flex-col gap-y-4">
          <div className="flex flex-col">
            <h1 className="text-[40px]">Bootstrap References</h1>
            <p className="text-[18px]">
              At W3Schools you will find complete BOOTSTRAP references of all
              properties and selectors with syntax, examples, browser support,
              and more.
            </p>
          </div>
          <div className="grid grid-cols-3 gap-y-4 gap-x-4 mb-10">
            {bootstrapreferences.map((item, i) => (
              <div
                key={i}
        ...
        <div className="flex flex-col items-start justify-start bg-[#292A34] h-auto w-auto p-10 gap-y-12 text-white dark:bg-[#0C1720] mb-20">
          ...
          <h1 className="text-[62px] text-[#FEC0C6] ">
            Get certified by completing a BOOTSTRAP course
          </h1>
