import {
  javaleftsidebaritems1,
  javaleftsidebaritems2,
  javaleftsidebaritems3,
  javareferences,
} from "../../constants";
  ...
  return (
    <main className="flex bg-[#E6E9EA] dark:bg-[#15212A] ">
      <span className="w-[20%] bg-[#E6E9EA] h-[3000px] text-black flex flex-col gap-y-2 pt-6 items-start overflow-auto scrollbar scrollbar-thin  dark:bg-[#15212A] dark:text-white">
        <h1 className="text-[21px] ml-4 mb-3">JAVA TUTORIAL</h1>
        <div>
          {javaleftsidebaritems1.map((item, i) => (
            <h1
              key={i}
        ...
        <h1 className="text-[21px] ml-4 mb-3">JAVA Advanced</h1>
        <div>
          {javaleftsidebaritems2.map((item, i) => (
            <h1 key={i} className="ml-4 cursor-pointer">
              {item}
            </h1>
          ))}
        </div>
        <h1 className="text-[21px] ml-4 mb-3">JAVA Responsive</h1>
        <div>
          {javaleftsidebaritems3.map((item, i) => (
            <h1 key={i} className="ml-4 cursor-pointer">
              {item}
            </h1>
          ))}
      ...
      <main className="bg-white w-full h-auto text-black dark:bg-[#1D2B34] dark:text-white pl-8  pr-8">
        <div className="mt-28">
          <h1 className="text-[40px] z-10 top-0 right-0 mb-5">JAVA Tutorial</h1>
        ...
        <div className="w-full bg-[#D8EFE1] mt-8 h-auto pt-10 pl-3 dark:bg-[#183D3C] mb-10">
          <div className="flex flex-col gap-y-5">
            ...
            <p>
              {" "}
              Java is a purely object-oriented programming language. Everything
              in Java is an object, and programs consist of classes and objects
        ...
        <div className="flex flex-col justify-start items-start gap-y-4">
          ...
          <p>This JAVA tutorial contains hundreds of Python examples.</p>
          <p>
        ...
        <div className="mt-6 mb-7">
          ...
          <p>
            ...
            Java, and click on a button to view the result.
          </p>
        ...
        <hr className="border mt-4" />
        <div className="mt-6 mb-7">
          <h1 className="text-[40px] mb-4">JAVA Templates</h1>
          <p className="mb-2">
            We have created some responsive W3.JAVA templates for you to use.
          </p>
          <p className="mb-2">
        ...
        <div className="mt-6 mb-7">
          <h1 className="text-[40px]">JAVA Exercises</h1>
        ...
        <div className="flex flex-col gap-y-3">
          <h1 className="text-[40px]">JAVA Quiz</h1>
        ...
        <div className="flex flex-col items-start justify-start bg-[#292A34] h-auto w-auto p-10 gap-y-12 text-white dark:bg-[#0C1720] mb-20">
          ...
          <h1 className="text-[62px] text-[#FEC0C6] ">
            Get certified by completing a JAVA course
          </h1>
