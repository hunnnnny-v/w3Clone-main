import {
  mysqlleftsidebaritems1,
  mysqlleftsidebaritems2,
  mysqlleftsidebaritems3,
  mysqlreferences,
} from "../../constants";
  ...
  return (
    <main className="flex bg-[#E6E9EA] dark:bg-[#15212A] ">
      <span className="w-[20%] bg-[#E6E9EA] h-[3010px] text-black flex flex-col gap-y-2 pt-6 items-start overflow-auto scrollbar scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 dark:bg-[#15212A] dark:text-white">
        <h1 className="text-[21px] ml-4 mb-3">MYSQL TUTORIAL</h1>
        <div>
          {mysqlleftsidebaritems1.map((item, i) => (
            <h1
              key={i}
        ...
        <h1 className="text-[21px] ml-4 mb-3">MYSQL Forms</h1>
        <div>
          {mysqlleftsidebaritems2.map((item, i) => (
            <h1 key={i} className="ml-4 cursor-pointer">
              {item}
            </h1>
          ))}
        </div>
        <h1 className="text-[21px] ml-4 mb-3">MYSQL References</h1>
        <div>
          {mysqlleftsidebaritems3.map((item, i) => (
            <h1 key={i} className="ml-4 cursor-pointer">
              {item}
            </h1>
          ))}
      ...
      <main className="bg-white w-full h-auto text-black dark:bg-[#1D2B34] dark:text-white pl-8  pr-8">
        ...
        <div className="w-full bg-[#D8EFE1] mt-8 h-auto pt-10 pl-3 dark:bg-[#183D3C] mb-10">
          <div className="flex flex-col gap-y-5">
            ...
            <p>
              MySQL is an open-source database, which means that its source code
              is freely available for anyone to view, modify, and distribute
            </p>
            <p>
              {" "}
              MySQL provides robust security features, including user
              authentication, access control, encryption, and auditing
            </p>
            <button className="bg-[#05AB6D] p-1 w-[30%] rounded-md text-white">
              Study our free MYSQL course &gt;&gt;
            </button>
        ...
        <div className="flex flex-col justify-start items-start gap-y-4">
          <h1 className="text-[40px]">
            Easy Learning with MYSQL &quot;Try it Yourself&quot;
          </h1>
          <p>
            With our &quot;Try it Yourself&quot; editor, you can edit the MYSQL
        ...
        <div className="mt-6 mb-7">
          <h1 className="text-[40px]">MYSQL Exercises</h1>
          <p>This MYSQL tutorial also contains nearly 100 MYSQL exercises.</p>
        </div>
        ...
        <div className="flex flex-col gap-y-3">
          <h1 className="text-[40px]">MYSQL Quiz Test</h1>
          <p>Test your MYSQL skills with our MYSQL Quiz!</p>
        ...
        <div className="flex flex-col gap-y-4">
          <div className="flex flex-col">
            <h1 className="text-[40px]">MYSQL References</h1>
            <p className="text-[18px]">
              At W3Schools you will find complete references about MYSQL
