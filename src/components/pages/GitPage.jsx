import {
  gitleftsidebaritems1,
  gitleftsidebaritems2,
  gitleftsidebaritems3,
  gitreferences,
} from "../../constants";
  ...
  return (
    <main className="flex bg-[#E6E9EA] dark:bg-[#15212A] ">
      <span className="w-[20%] bg-[#E6E9EA] h-[3010px] text-black flex flex-col gap-y-2 pt-6 items-start overflow-auto scrollbar scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 dark:bg-[#15212A] dark:text-white">
        <h1 className="text-[21px] ml-4 mb-3">GIT TUTORIAL</h1>
        <div>
          {gitleftsidebaritems1.map((item, i) => (
            <h1
              key={i}
        ...
        <h1 className="text-[21px] ml-4 mb-3">GIT Forms</h1>
        <div>
          {gitleftsidebaritems2.map((item, i) => (
            <h1 key={i} className="ml-4 cursor-pointer">
              {item}
            </h1>
          ))}
        </div>
        <h1 className="text-[21px] ml-4 mb-3">GIT References</h1>
        <div>
          {gitleftsidebaritems3.map((item, i) => (
            <h1 key={i} className="ml-4 cursor-pointer">
              {item}
            </h1>
          ))}
      ...
      <main className="bg-white w-full h-auto text-black dark:bg-[#1D2B34] dark:text-white pl-8  pr-8">
        <div className="mt-28">
          <h1 className="text-[40px] z-10 top-0 right-0 mb-5">GIT Tutorial</h1>
        ...
        <div className="w-full bg-[#D8EFE1] mt-8 h-auto pt-10 pl-3 dark:bg-[#183D3C] mb-10">
          <div className="flex flex-col gap-y-5">
            <p>It is used to track changes in the source code of a software project over time. </p>
            <p> In Git, you commit changes to the local repository. A commit is like a snapshot of your code at a specific point in time.</p>
            <p> Git provides tools to undo changes, including reverting to a previous commit or resetting the repository to a specific state.</p>
            <button className="bg-[#05AB6D] p-1 w-[30%] rounded-md text-white">
              Study our free GIT course &gt;&gt;
            </button>
        ...
        <div className="flex flex-col justify-start items-start gap-y-4">
          <h1 className="text-[40px]">
            Easy Learning with GIT &quot;Try it Yourself&quot;
          </h1>
          <p>
            With our &quot;Try it Yourself&quot; editor, you can edit the GIT
        ...
        <div className="mt-6 mb-7">
          <h1 className="text-[40px]">GIT Exercises</h1>
          <p>This GIT tutorial also contains nearly 100 HTML exercises.</p>
        </div>
        ...
        <div className="flex flex-col gap-y-3">
          <h1 className="text-[40px]">GIT Quiz Test</h1>
          <p>Test your GIT skills with our GIT Quiz!</p>
        ...
        <div className="flex flex-col gap-y-4">
          <div className="flex flex-col">
            <h1 className="text-[40px]">GIT References</h1>
            <p className="text-[18px]">
              At W3Schools you will find complete references about GIT
