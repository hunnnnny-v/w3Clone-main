import {
  pythonleftsidebaritems1,
  pythonleftsidebaritems2,
  pythonleftsidebaritems3,
  pythonreferences,
} from "../../constants";
  ...
  return (
    <main className="flex bg-[#E6E9EA] dark:bg-[#15212A] ">
      <span className="w-[20%] bg-[#E6E9EA] h-[3000px] text-black flex flex-col gap-y-2 pt-6 items-start overflow-auto scrollbar scrollbar-thin  dark:bg-[#15212A] dark:text-white">
        <h1 className="text-[21px] ml-4 mb-3">PYTHON TUTORIAL</h1>
        <div>
          {pythonleftsidebaritems1.map((item, i) => (
            <h1
              key={i}
        ...
        <div>
          {pythonleftsidebaritems2.map((item, i) => (
        ...
        <div>
          {pythonleftsidebaritems3.map((item, i) => (
            <h1 key={i} className="ml-4 cursor-pointer">
              {item}
            </h1>
          ))}
