import {
  chashleftsidebaritems1,
  chashleftsidebaritems2,
  chashleftsidebaritems3,
  chashreferences,
} from "../../constants";
  ...
  return (
    <main className="flex bg-[#E6E9EA] dark:bg-[#15212A] ">
      <span className="w-[20%] bg-[#E6E9EA] h-[3000px] text-black flex flex-col gap-y-2 pt-6 items-start overflow-auto scrollbar scrollbar-thin  dark:bg-[#15212A] dark:text-white">
        ...
        <div>
          {chashleftsidebaritems1.map((item, i) => (
            <h1
              key={i}
        ...
        <h1 className="text-[21px] ml-4 mb-3">C# Advanced</h1>
        <div>
          {chashleftsidebaritems2.map((item, i) => (
            <h1 key={i} className="ml-4 cursor-pointer">
              {item}
            </h1>
          ))}
        </div>
        <h1 className="text-[21px] ml-4 mb-3">C# Responsive</h1>
        <div>
          {chashleftsidebaritems3.map((item, i) => (
            <h1 key={i} className="ml-4 cursor-pointer">
              {item}
            </h1>
          ))}
      ...
      <main className="bg-white w-full h-auto text-black dark:bg-[#1D2B34] dark:text-white pl-8  pr-8">
        <div className="mt-28">
          <h1 className="text-[40px] z-10 top-0 right-0 mb-5">C# Tutorial</h1>
        ...
        <div className="w-full bg-[#D8EFE1] mt-8 h-auto pt-10 pl-3 dark:bg-[#183D3C] mb-10">
          <div className="flex flex-col gap-y-5">
            ...
            <button className="bg-[#05AB6D] p-1 w-[30%] rounded-md text-white font-semibold mb-2">
              Start learning PC#now!!
            </button>
          </div>
        </div>
        <div className="flex flex-col justify-start items-start gap-y-4">
          <h1 className="text-[40px]">Examples in Each Chapter</h1>
          <p>This PC#tutorial contains hundreds of PC#examples.</p>
          <p>
            With our online editor, you can edit the PC# and click on a button
            to view the result.
          </p>
        </div>
        ...
        <div className="mt-6 mb-7">
          <h1 className="text-[40px] mb-4">C# Examples</h1>
          <p>
        ...
        <hr className="border mt-4" />
        <div className="mt-6 mb-7">
          <h1 className="text-[40px] mb-4">C# Templates</h1>
          <p className="mb-2">
            We have created some responsive W3.PC#templates for you to use.
          </p>
          <p className="mb-2">
        ...
        <div className="mt-6 mb-7">
          <h1 className="text-[40px]">C# Exercises</h1>
          <p>ThiC# tutorial also contains nearly 10C# exercises.</p>
        </div>
        ...
        <div className="flex flex-col gap-y-3">
          <h1 className="text-[40px]">C# Quiz</h1>
        ...
        <div className="flex flex-col gap-y-4">
          <div className="flex flex-col">
            <h1 className="text-[40px]">C# References</h1>
            <p className="text-[18px]">
              At W3Schools you will find complete PC#references of all
              properties and selectors with syntax, examples, browser support,
              and more.
            </p>
          </div>
          <div className="grid grid-cols-3 gap-y-4 gap-x-4 mb-10">
            {chashreferences.map((item, i) => (
              <div
                key={i}
        ...
        <div className="flex flex-col items-start justify-start bg-[#292A34] h-auto w-auto p-10 gap-y-12 text-white dark:bg-[#0C1720] mb-20">
          ...
          <h1 className="text-[62px] text-[#FEC0C6] ">
            Get certified by completing a C# course
          </h1>
